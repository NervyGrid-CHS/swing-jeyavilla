<?php
$con = mysqli_connect("localhost", "root", "", "swing");
$count = mysqli_fetch_array(mysqli_query($con, "SELECT COUNT(*) FROM newd"));
$coun = mysqli_fetch_array(mysqli_query($con, "SELECT COUNT(*) FROM admin"));
?>
<!doctype html>
